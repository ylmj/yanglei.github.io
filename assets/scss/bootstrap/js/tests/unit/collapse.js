$(function () {
  ...
  QUnit.test('should show multiple collapsed elements', function (assert) {
    assert.expect(4)
    var done = assert.async()
    var $target = $('<a role="button" data-toggle="collapse" class="collapsed" href="../../../../../../../assets/scss/bootstrap/js/tests/unit/.multi"/>').appendTo('#qunit-fixture')
  ...
  QUnit.test('should add "collapsed" class to triggers only when all the targeted collapse are hidden', function (assert) {
    ...
    var $trigger3 = $('<a role="button" data-toggle="collapse" href="../../../../../../../assets/scss/bootstrap/js/tests/unit/.multi"/>').appendTo('#qunit-fixture')
